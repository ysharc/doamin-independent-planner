...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        effects_add_action_1 = set(action_1.effect_add)
        effects_add_action_2 = set(action_2.effect_add)
        effects_rem_action_1 = set(action_1.effect_rem)
        effects_rem_action_2 = set(action_2.effect_rem)

        return not (effects_add_action_1.isdisjoint(effects_rem_action_2) and
                    effects_add_action_2.isdisjoint(effects_rem_action_1))
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        action_1 = node_a1.action
        action_2 = node_a2.action
        effects_rem_action_1 = set(action_1.effect_add)
        effects_rem_action_2 = set(action_2.effect_add)
        pre_cond_action_1 = set(action_1.precond_pos)
        pre_cond_action_2 = set(action_2.precond_pos)

        return not (effects_rem_action_1.isdisjoint(pre_cond_action_2) and
                    effects_rem_action_2.isdisjoint(pre_cond_action_1))
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            state_node = PgNode_s(goal, True)
            for current_level, level_state in enumerate(self.s_levels):
                if state_node in level_state:
